...
function addToHistory(service, number) {
  ...
  div.innerHTML= `<div class="flex flex-col"> <span class="font-semibold">${service}<span>`
  div.innerHTML = `<div class="flex flex-col"> <span class="text-sm text-gray-600">${number}<span> </div>
